...
$_['help_seo_url'] = 'Pour utiliser les adresses universelles (URL) de référencement optimisées pour les moteurs de recherche (SEO), le module de réécriture (rewrite) Apache soit être installé et vous devez renommer le fichier <htaccess.txt> en <.htaccess>.';
...
$_['error_log_required'] = 'Nom du fichier du journal des erreurs requis !';
$_['error_log_invalid'] = 'Nom du fichier du journal des erreurs invalide !';
$_['error_log_extension'] = 'L’extension du fichier du journal des erreurs doit être <.log> !';
